...
<div class="page-wrapper">
  ...
  <main>
    ...
    <form class="form container <?=$error;?>" action="/sign-up.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
      ...
      <div class="form__item <?=$errors['password'];?>">
        ...
        <input id="password" type="text" name="password" value="<?=htmlspecialchars($lots['password']);?>" placeholder="Введите пароль">
        <span class="form__error">Введите пароль</span>
      </div>
      <div class="form__item <?=$errors['name'];?>">
        <label for="name">Имя*</label>
        <input id="name" type="text" name="name" value="<?=htmlspecialchars($lots['name']);?>" placeholder="Введите имя">
        <span class="form__error">Введите имя</span>
      </div>
      <div class="form__item <?=$errors['message'];?>">
        <label for="message">Контактные данные*</label>
        <textarea id="message" name="message" placeholder="Напишите как с вами связаться"><?=htmlspecialchars($lots['message']);?></textarea>
