...
<div class="page-wrapper">
  ...
  <main>
    ...
    <form class="form form--add-lot container <?=$error;?>" action="/add.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
      <h2>Добавление лота</h2>
      <div class="form__container-two">
        <div class="form__item <?=$errors['lot_name'];?>"> <!-- form__item--invalid -->
          <label for="lot-name">Наименование</label>
          <input id="lot-name" type="text" name="lot_name" value="<?=htmlspecialchars($lots['lot_name']);?>"placeholder="Введите наименование лота">
      ...
      <div class="form__item form__item--wide <?=$errors['message'];?>">
        ...
        <textarea id="message" name="message"><?=htmlspecialchars($lots['message']);?></textarea>
        <span class="form__error">Напишите описание лота</span>
      </div>
      <div class="form__item form__item--file <?=$errors['lot_img'];?>"> <!-- form__item--uploaded -->
      ...
      <div class="form__container-three">
        <div class="form__item form__item--small <?=$errors['lot_rate'];?>">
          <label for="lot-rate">Начальная цена</label>
          <input id="lot-rate" type="number" name="lot_rate" value="<?=htmlspecialchars($lots['lot_rate']);?>">
          <span class="form__error">Введите начальную цену</span>
        </div>
        <div class="form__item form__item--small <?=$errors['lot_step'];?>">
          <label for="lot-step">Шаг ставки</label>
          <input id="lot-step" type="number" name="lot_step" value="<?=htmlspecialchars($lots['lot_step']);?>" placeholder="0">
          <span class="form__error">Введите шаг ставки</span>
        </div>
        <div class="form__item <?=$errors['lot_date'];?>">
          <label for="lot-date">Дата окончания торгов</label>
          <input class="form__input-date" id="lot-date" type="date" name="lot_date" value="<?=htmlspecialchars($lots['lot_date']);?>">
          <span class="form__error form__item--invalid">Введите дату завершения торгов</span>
        </div>
      </div>
